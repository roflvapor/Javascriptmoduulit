...
const modimg = dialog.querySelector('img');
const closemod = dialog.querySelector('span');

for(let i of picArray){
    const c1 = document.createElement('article');

    const c2 = document.createElement('h2')
    c2.innerHTML = i.title;

    const c3 = document.createElement('figure');
    const c4 = document.createElement('img');
    c4.src = i.image.medium;
    c4.alt = i.title;

    const cap = document.createElement('figcaption');
    cap.innerHTML = i.caption;
